...
class DataTransformation:  #### Function is responsible for data transformation 
    def __init__(self):
            self.data_transformation_config = Datatransformationconfig()

    def get_data_transformer_object(self): ##### Create all the pickel files 
         try:
             ...
             logging.info("Numerical Columns pipeline(Imputing and Scaler) completed")
